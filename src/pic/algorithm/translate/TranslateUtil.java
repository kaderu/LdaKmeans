package pic.algorithm.translate;
...
public class TranslateUtil {
    ...
    protected static final String INDONESIA = "id"; // 日
    ...
    public static String id2en(final String text) throws Exception {
        return translate(text, INDONESIA, ENGLISH);
    }

    public static void main(String[] args) {
        try {
            System.out.println(id2en("bayi"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
