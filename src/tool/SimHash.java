...
/**
 * Created by zhangshangzhi on 2017/8/12.
 */
...
public class SimHash {
    ...
    public static void main(String[] args) {
        String s = "Super heroes,Doctor strange, lego, super heroes doctor strange's sanctum sanctorum ";
        ...
        System.out.println("\n");
        s = "Super heroes,Tanker truck, lego, super heroes tanker truck takedown";
        SimHash hash2 = new SimHash(s, 64);
        System.out.println(hash2.intSimHash+ "  " + hash2.intSimHash.bitCount());
        hash1.subByDistance(hash2, 3);
        s = "Technic,Fire plane, lego, technic fire plane";
